...
2. Fill required values:
   ...
   - `AUTH_BOOTSTRAP_DEFAULT_PASSWORD` (dev default is `admin123`)
...
- Recommended defaults:
  ...
  - prod: `APP_SEED_ENABLED=false`, keep `APP_SEED_TENANT_ID` empty unless running seed, do not use weak/default bootstrap password
